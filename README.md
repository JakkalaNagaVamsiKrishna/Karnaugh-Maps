...
compile and run the v1.cpp file along with providing the prompted inputs 

Make sure the variable names are single character 

You can see a file named "kmap.svg" containing a visualisation of the KMap for the corresponding inputs  
